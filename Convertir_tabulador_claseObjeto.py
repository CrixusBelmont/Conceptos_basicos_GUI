...
#En este archivo se comvierte toda la ventana de tabulador en un objeto, lo cual implica convertirlo en clase
#Eso es para que sea reutilizable
#Para hacerloempieza por crear la clase, luego define el metodo __init__ y finalmente el metodo super con init
#Despues de eso reemplazas venta por self (Los que estan dentro del metodo init)
#Luego, los otros metodos def que estan alineados con el init, dentro del parentesis agregas self como argumento
#Pero no los agregas a los metodos que estan dentro de dichos metodos, o sea los def de los def
#Todos los metodos y nombres que lleven la palabra crear, lo conviertes en un metodo protegido
#Es decir, colocarles un _ antes de la palabra
#Dentro del metodo crear tabs, les agregas self._ a los que se llamen crear componentes
#El argumento o parametro de la funcion Notebook debe llevar self
#Agregas el if__name__== '__main__:' a los metodos finales de la ventana
