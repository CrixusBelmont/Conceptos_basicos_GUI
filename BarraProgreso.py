...
#En este archivo se ha creado un quinto tabulador y sus componentes
#Se trata de una barra de progreso que ves por ejemplo en una instalacion
#El boton ejecutar barra progreso que tiene la variable de boton_inicio
#Y con el comando con la funcion de ejecutar_barra
#Tiene la particularidad de que no se puede detener manuelmente con ninguno de los dos botones existentes para detener la barra
#Eso se debe a que no tiene el metodo de start y por lo tanto tampoco podria estar el metodo de stop
#EL boton de ejecutar barra tiene dentro de su metodo la funcion sleep
#Lo cual permite ajustar el tiempo en que la barra avance

 #Ver archivo final: Convertir_tabulador_claseObjeto