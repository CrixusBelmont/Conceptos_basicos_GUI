...
#En este archivo se crea un tercer tabulador y sus componentes
#Se usa combobox para crear una caja de entrada con opciones multiples
#En este caso los numeros del 1 al 10, especificados en la variable de datos
# En combobox.current(5) es para mostrar el valor de 5 por default en la caja, puede ser cualquier otro

#Ver el archivo a continuacion: Manejo de imagen