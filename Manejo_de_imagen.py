...
#En este archivo se crea un cuerto tabulador con sus componentes
#Basicamente se trata de colocar una imagen al tabulador
#Y mostrar su informacion al hacer click a la imagen
#Es decir, convertir una imagen en un boton


#Ver el archivo a continuacion: Barra progreso
